...
    
    // --- 1. ADICIONADO CÓDIGO DE PRÉ-CARREGAMENTO DOS LOGOS ---
    const logoLightUrl = "/lovable-uploads/d3026126-a31a-4979-b9d5-265db8e3f148.png";
    const logoDarkUrl = "/lovable-uploads/75b65017-8e97-493c-85a8-fe1b0f60ce9f.png";
    ...
    // --- FIM DO CÓDIGO DE PRÉ-CARREGAMENTO ---
...
              {/* --- 2. SUBSTITUÍDO <img> POR <div> COM BACKGROUND-IMAGE --- */}
              <div
                role="img"
                aria-label="Synergy AI logo"
...
      _message:               <li>Infra dedicada e SLA</li>
                    </ul>
                    <Button variant="outline" className="mt-6" onClick={() => setShowAuthModal(true)}>
                      Começar agora
                    </Button>
