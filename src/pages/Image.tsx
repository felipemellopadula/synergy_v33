                             ...
                             {isGenerating ? (
                                 ...
                                 <div className="flex flex-col h-full">
                                     <div className="relative flex-grow">
                                         ...
                                         {/* Botões sobrepostos em telas maiores */}
                                         <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/80 to-transparent sm:flex items-center justify-between gap-2 hidden">
                                     ...
                                     {/* Botões abaixo da imagem em telas menores */}
                                     <div className="sm:hidden flex flex-col items-stretch gap-2 p-4">
